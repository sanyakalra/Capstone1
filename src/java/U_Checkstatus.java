 ...
 * @author Sanya
 */
@WebServlet(urlPatterns = {"/U_Checkstatus"})
public class U_Checkstatus extends HttpServlet {
    ...
    RequestDispatcher dispatcher = request.getRequestDispatcher("User_Checkstatus.jsp");
